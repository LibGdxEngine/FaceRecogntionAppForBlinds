...
import org.tensorflow.lite.examples.detection.TrustedPersonsActivity.TrustedPersonsActivity;
...
//  //private static final String TF_OD_API_MODEL_FILE = "facenet_hiroki.tflite";
  ...
  private static Size DESIRED_PREVIEW_SIZE = new Size(620, 480);
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    fabShowTrustedPersons.setOnClickListener(view -> {
      Intent intent = new Intent(DetectorActivity.this, TrustedPersonsActivity.class);
...
//        final int inHeight = transpose ? srcWidth : srcHeight;
  ...
  private void showAddFaceDialog(SimilarityClassifier.Recognition rec) {
    //TODO: add another field for phone number
  ...
  private void updateResults(long currTimestamp,
